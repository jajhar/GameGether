//
//  NewMessagePopUpViewController.swift
//  GameGether
//
...
class NewMessagePopUpViewController: UIViewController, ShowsNavigationOverlay {
    ...
    // MARK: - Properties
    public var buttonTitle: String = "new msg"
    ...
    private func setupView() {
        newMessageButton.setTitle(buttonTitle, for: .normal)
        view.layoutIfNeeded()
        resize()
    }
